...
CREATE TABLE IF NOT EXISTS orders (
  ...
  designer_not_needed  TINYINT(1) NOT NULL DEFAULT 0,
  ...
  needs_customer_info  TINYINT(1) NOT NULL DEFAULT 0,
  created_at           DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at           DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
...
CREATE TABLE IF NOT EXISTS conversations (
  ...
  label          ENUM('EDIT','PAYMENT','CUSTOM','IMPORTANT','HELP') NULL,
  source         ENUM('PORTAL','SITE_CHAT') NOT NULL DEFAULT 'PORTAL',
  archived       TINYINT(1) NOT NULL DEFAULT 0,
  hidden_from_client TINYINT(1) NOT NULL DEFAULT 0,
  starred_admin  TINYINT(1) NOT NULL DEFAULT 0,
  starred_client TINYINT(1) NOT NULL DEFAULT 0,
