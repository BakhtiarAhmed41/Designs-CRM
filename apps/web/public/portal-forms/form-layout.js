(function () {
  ...
  css.textContent = [
    ...
    '.nq-size-row{align-items:flex-end!important;flex-wrap:nowrap!important;}',
    '.nq-size-row .nq-check{margin:0!important;}',
    '.nq-size-row .nq-add{margin:0!important;}',
    '.nq-x{height:44px!important;padding:0!important;display:flex!important;align-items:center!important;}',
    '.nq-size-opts{min-height:44px!important;align-items:center!important;}',
    '.nq-extra-del{width:44px!important;height:44px!important;min-width:44px!important;padding:0!important;margin:0!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;}',
    '.nq-extra-del i{font-size:20px!important;line-height:1!important;}',
    '@media(max-width:720px){.nq-size-row{flex-wrap:wrap!important;}}',
